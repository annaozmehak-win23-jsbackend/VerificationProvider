        ...
        try
        {
            if (!string.IsNullOrEmpty(verificationRequest.Email) && !string.IsNullOrEmpty(code))
            {
                var emailRequest = new EmailRequest()
                {
                         ...
                         <body>
                            <div style='color: #191919; max-width: 500px'>
                                ...
                                <div style='background-color: #f4f4f4'; padding: 1rem 2rem;'>
                                    ...
                                    <p class='code' style='font-weight: 700; text-align: center; font-size: 48px; letter-spacing: 1.5px;'>
                                        {code}
                                    </p>
                                    <div style='color: #191919; font-size: 11px;'>
                                        <p>If you did not request this code, it is possible that someone else is trying to access the Silicon Account<span>Account {verificationRequest.Email}. This email can't receive replies. For more information, visit the Silicons Help Center</span></p>
                                    </div>
                                </div>
                    ...
                    ",
                    PlainText = $"Please verify your account using this verification code: {code}. If you did not request this code, it is possible that someone else is trying to access the Silicon Account {verificationRequest.Email}. This email can't receive replies. For more information, visit the Silicons Help Center"
                };
